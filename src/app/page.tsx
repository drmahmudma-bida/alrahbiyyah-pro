        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#060b19] border border-yellow-700/50 rounded-2xl p-10 text-center flex flex-col items-center shadow-[0_0_30px_rgba(202,138,4,0.05)]">
              ...
              <Link href="/pro" className="mt-auto px-6 py-3 bg-yellow-600 text-black rounded-full hover:bg-yellow-500 transition-colors w-full font-bold">Access Pro Tools</Link>
            </div>
          </div>
        </div>
      </section>
